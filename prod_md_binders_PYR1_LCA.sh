...
gmx_mpi grompp -f $MDP/prod_md_HMR_3dt.mdp -c $DIR/binders/${PREFIX}_${ID}_binder/NPT/npt.gro -t $DIR/binders/${PREFIX}_${ID}_binder/NPT/npt.cpt -p $DIR/binders/${PREFIX}_${ID}_binder/${PREFIX}_${ID}_dodecahedron_HMR.top -o prod_md_500ns.tpr
